...
import com.bestbuy.productinfo.categoryinfo.CategorySteps;
...
public class CategoryCRUDtestWithSteps extends TestBase {
    ...
    static String name = "Tree Trolly" + TestUtils.getRandomValue();
    static String id  = "8" + TestUtils.getRandomValue();
